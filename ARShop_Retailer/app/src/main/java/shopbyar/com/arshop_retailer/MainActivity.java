    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawer = new DrawerBuilder()
                ...
                .addDrawerItems(
                        ...
                        new PrimaryDrawerItem().withName("My Shops").withIcon(GoogleMaterial.Icon.gmd_shopping_basket),
                        new PrimaryDrawerItem().withName("My Photos").withIcon(GoogleMaterial.Icon.gmd_book_photo),
                        new SectionDrawerItem(),
                        new PrimaryDrawerItem().withName("Logout").withIcon(GoogleMaterial.Icon.gmd_power_off)
                )
